    ...
    <table bgcolor="#fff" width="600px" cellpadding="0" cellspacing="0" border="0">
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="padding: 0 80px;">
                    <tr>
                        <td width="220px" style="padding-right: 20px; color: #333333">
                            <img src="assets/image 1.jpg" alt="Perfume">
                        ...
                        <td width="220px" style="padding-left: 20px; color: #333333">
                            <img src="assets/Rectangle 3.jpg" alt="Estojo de maquiagem">
        ...
        <tr bgcolor="#6F967E" height="40px" style="vertical-align: middle;">
            ...
            <td  align="left" width="50%" style="display: inline-block;">
                <img src="assets/facebook-square-brands.svg" alt="Facebook" style="width: 20px; height: 40px; margin-left: 5px;">
                <img src="assets/instagram-square-brands.svg" alt="Instagram" style="width: 20px; height: 40px; margin-left: 5px;">
                <img src="assets/twitter-square-brands.svg" alt="Twitter" style="width: 20px; height: 40px; margin-left: 5px;">
                <img src="assets/youtube-square-brands.svg" alt="Youtube" style="width: 20px; height: 40px; margin-left: 5px;">
        ...
        <tr height="60">
            <td align="center">
                <img src="assets/logo.svg" alt="Logo" style="width: 100px;">
            </td>
        </tr>
        <tr>
